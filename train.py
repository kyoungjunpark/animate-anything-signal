...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    noise_scheduler, tokenizer, text_encoder, vae, unet = load_primary_models(pretrained_model_path, in_channels,
                                                                              motion_strength=motion_strength)
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("animate_only")
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                if should_sample(global_step, validation_steps, validation_data) and accelerator.is_main_process:
                    ...
                    with accelerator.autocast():
                        batch_eval(accelerator.unwrap_model(unet), accelerator.unwrap_model(text_encoder), vae,
