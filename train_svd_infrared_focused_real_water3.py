...
from models.pipeline_infrared_real3 import MaskStableVideoDiffusionPipeline
...
def finetune_unet(accelerator, pipeline, batch, use_offset_noise,
    ...
    images_latent = image_pool2(images_latent)
    ...
    infrared_images = vae.encode(infrared_images).latent_dist.mode()
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("infrared_real_water3")
